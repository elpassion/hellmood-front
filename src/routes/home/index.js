          ...
          <div className={style.homeSection}>
            <div className={commonStyle.container}>
              ...
              <div className={style.moodBlock}>
                ...
                <div className={style.moodBlockEmpty}></div>
                <p className={classnames(commonStyle.moodIconWrapper, commonStyle.usUnhappy)} >
              ...
              <div className={style.moodBlock}>
                <time className={style.moodDate}>10 pm</time>
                <div className={style.averageMood}>
                  <p>Current mood:</p>
                </div>
                <div className={style.moodBlockEmpty}></div>
                ...
                <div className={style.moodBlockEmpty}></div>
                <div className={style.moodBlockCommentWrapper}>
                  <p className={style.commentTitle}>Comment:</p>
                  <p className={style.commentContent}>Call with a client just blew my mind!</p>
                </div>
              </div>
            </div>
          </div>
